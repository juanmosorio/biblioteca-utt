 ...
 * @author JUAN
 */
public class LoginToAdmin extends javax.swing.JFrame {
    ...
    public static String vRool;
    private String vPass = "", vUser = "";
    ...
    void searchUser(String user, String pass) {
        ResultSet result = controller.loginAdmin(user, pass);
        try {
            if (result.next()) {
                vUser = result.getString("nombre");
                vPass = result.getString("pass");
                vRool = result.getString("rool");
            }
    ...
    private void btnValidateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValidateActionPerformed
        if (txfUser.getText().isEmpty() && psfContrasenia.getPassword().toString().isEmpty()) {
            ...
            if (user.equals(vUser) && pass.equals(vPass)) {
                this.dispose();
                SplashScreen splash = new SplashScreen("Bienvenido: " + user + " acceso satisfactorio");
